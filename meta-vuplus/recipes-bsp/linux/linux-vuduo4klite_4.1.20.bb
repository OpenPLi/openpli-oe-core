...
SRC_URI += "https://source.mynonpublic.com/vuplus.de/linux/vuplus-linux-${PV}-${SRC_DATE}.tar.gz \
    ...
    file://0004-af9035-add-USB-ID-07ca-0337-AVerMedia-HD-Volar-A867_l.patch \
    file://0005-Add-support-for-EVOLVEO-XtraTV-stick_l.patch \
    ...
    file://0008-add-Hama-Hybrid-DVB-T-Stick-support_l.patch \
    file://0009-Add-Terratec-H7-Revision-4-to-DVBSky-driver.patch \
    file://0010-media-Added-support-for-the-TerraTec-T1-DVB-T-USB-tu_l.patch \
    file://0011-media-tda18250-support-for-new-silicon-tuner.patch \
    file://0012-media-dib0700-add-support-for-Xbox-One-Digital-TV-Tu_l.patch \
    ...
    file://linux3.4-ARM-8933-1-replace-Sun-Solaris-style-flag-on-section_l.patch \
"
...
kernel_do_install:append() {
        ...
        install -m 0755 ${WORKDIR}/vufindkerneldevice.py ${D}/${KERNEL_IMAGEDEST}
}
...
pkg_postinst:kernel-image () {
    if [ -d /proc/stb ]; then
        if [ -f /${KERNEL_IMAGEDEST}/${KERNEL_IMAGETYPE} ]; then
            python /${KERNEL_IMAGEDEST}/vufindkerneldevice.py
            [ -e /dev/kernel ] && dd if=/${KERNEL_IMAGEDEST}/${KERNEL_IMAGETYPE} of=/dev/kernel
        fi
    fi
    rm -f /${KERNEL_IMAGEDEST}/${KERNEL_IMAGETYPE}
    rm -f /${KERNEL_IMAGEDEST}/vufindkerneldevice.py
    true
}
