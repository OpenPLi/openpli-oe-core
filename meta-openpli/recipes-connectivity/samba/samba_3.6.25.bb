...
INITSCRIPT_PACKAGES = "sambaserver"
INITSCRIPT_NAME_sambaserver = "sambaserver"
INITSCRIPT_PARAMS = "defaults"
CONFFILES_sambaserver = "${sysconfdir}/samba/smb.conf ${sysconfdir}/samba/private/users.map ${sysconfdir}/samba/private/smbpasswd"
...
do_compile () {
    perl -i -pe 's/Globals\.maxprotocol = PROTOCOL_NT1/Globals.maxprotocol = PROTOCOL_SMB2/gis;' -pe 's/Globals\.szPassdbBackend, \"tdbsam\"/Globals.szPassdbBackend, \"smbpasswd\"/gis;' -pe 's/Globals\.szIdmapBackend, \"tdb\"/Globals.szIdmapBackend, \"smbpasswd\"/gis;' ${S}/param/loadparm.c
    base_do_compile
}
...
do_install_append() {
    ...
    ln -sf ../sbin/samba_multicall ${D}${sbindir}/smbpasswd
    cp ${D}${bindir}/testparm ${D}${sbindir}/testparm
    
    install -D -m 755 ${WORKDIR}/init ${D}${sysconfdir}/init.d/samba
    install -D -m 755 ${WORKDIR}/init ${D}${sysconfdir}/init.d/sambaserver
...
FILES_sambaserver      = "${sbindir}/samba_multicall ${sbindir}/smbd ${sbindir}/nmbd \
