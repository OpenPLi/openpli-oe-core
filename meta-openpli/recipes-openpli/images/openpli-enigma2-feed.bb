...
OPTIONAL_WIFI_PACKAGES = "\
	${@ 'kernel-module-8812au' if ("${KERNEL_VERSION}" and bb.utils.vercmp_string("${KERNEL_VERSION}", '3.9') < 0) else '' } \
	${@ 'kernel-module-8814au' if ("${KERNEL_VERSION}" and bb.utils.vercmp_string("${KERNEL_VERSION}", '3.9') < 0) else '' } \
	...
	\
	${@ 'kernel-module-88xxau' if ("${KERNEL_VERSION}" and bb.utils.vercmp_string("${KERNEL_VERSION}", '3.9') >= 0) else '' } \
